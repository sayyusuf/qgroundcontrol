...
Q_DECLARE_LOGGING_CATEGORY(ObstacleManagerLog)

/// This is the base class for firmware specific Obstacle managers. A Obstacle manager is responsible
/// for communicating with the vehicle to set/get Obstacle settings.
class ObstacleManager : public PlanManager
{
    Q_OBJECT
    
public:
    ObstacleManager(Vehicle* vehicle);
    ~ObstacleManager();
