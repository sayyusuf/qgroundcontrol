...
Item {
    ...
    property var    _polygons:                  myObstacleController.polygons
    property var    _circles:                   myObstacleController.circles
    ...
    function addPolygon(inclusionPolygon) {
        ...
        if (inclusionPolygon) {
            myObstacleController.addInclusion(topLeftCoord, bottomRightCoord)
        } else {
            myObstacleController.addExclusion(topLeftCoord, bottomRightCoord)
        }
    }
    ...
    Component {
        ...
        MapCircle {
            ...
            property real _radius: myObstacleController.paramCircularFence
    ...
    Component {
        ...
        MissionItemIndicatorDrag {
            mapControl:     map
            itemCoordinate: myObstacleController.breachReturnPoint
            visible:        _root.interactive

            onItemCoordinateChanged: myObstacleController.breachReturnPoint = itemCoordinate
        }
    }
    ...
    Component {
        ...
        MapQuickItem {
            ...
            z:              QGroundControl.zOrderMapItems
            coordinate:     myObstacleController.breachReturnPoint
